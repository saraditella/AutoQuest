...
<div class="container">
    ...
    <div class="user-details-grid">
        ...
        <span class="value">${sessionScope.utenteLoggato.email}</span>

        <span class="label">ID Utente:</span>
        <span class="value">${sessionScope.utenteLoggato.idUtente}</span>

        <span class="label">Ruolo:</span>
        <span class="value">${sessionScope.utenteLoggato.ruolo}</span>
    </div>
